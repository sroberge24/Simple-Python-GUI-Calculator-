...
#Creating the frames to organize the widgets
 #top frame
...
# The first row of bottom frame includes 2 buttons, 'Clear (Clear)' and 'Divide (/)':
...
btn_clearing=tk.Button(btns_frame, text="Clear", fg="black", width=32, height=3, bd=0, bg="#eee",
    ...
    #posititon the button clear in the grid
...
#Fifth row includes 4 buttons , '1', '2', '3', and 'plus (+)':
